/*****************************************************************c******************o*******v******id********
 * File Name: HttpErrorAsJSONServlet
...
public class HttpErrorAsJSONServlet extends HttpServlet implements Serializable {
    ...
    /**
     * Description: Sets object mapper.
     * 
     * @param objectMapper
     */
    ...
    /**
     * Description: Service method that will write out the status code and reason phrase.
     * 
     * @param request
     * @param response
     */
